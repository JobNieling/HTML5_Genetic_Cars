(function () {
...
})()(
  {
    1: [
      function (require, module, exports) {
        ...
        function generationZero() {
          var obj = Object.keys(manageRound).reduce(
            function (obj, key) {
              obj.states[key] = manageRound[key].generationZero(
                generationConfig()
              );
      ...
      {
        "./draw/plot-graphs.js": 6,
        "./generation-config": 10,
        "./machine-learning/genetic-algorithm/manage-round.js": 14,
        "./machine-learning/simulated-annealing/manage-round.js": 16,
        "./world/run.js": 17,
      },
    ],
    2: [
...
*/
      ...
      { "../machine-learning/create-instance": 13 },
    ],
    5: [
      function (require, module, exports) {
        module.exports = {
    ...
    10: [
      ...
      {
        "../car-schema/construct.js": 3,
        "./generateRandom": 8,
        "./pickParent": 11,
        "./selectFromAllParents": 12,
      },
    ],
    11: [
      function (require, module, exports) {
    ...
    16: [
      function (require, module, exports) {
        ...
        function nextGeneration(previousState, scores, config) {
          ...
          var temp = Math.pow(
            Math.E,
            -nextState.counter / config.generationSize
          );
          ...
          if (scoreDiff > 0) {
            ...
            Math.random() > Math.exp(-scoreDiff / (nextState.k * temp))
          ) {
            nextState.curDef = newDef;
            nextState.score = newScore;
          } else {
          ...
          nextState.generation = [
            createStructure(config, temp, nextState.curDef),
          ];
